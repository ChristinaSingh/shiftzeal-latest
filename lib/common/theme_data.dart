...
import 'package:shiftzeal/common/text_styles.dart';
      ...
      radioTheme: RadioThemeData(
        fillColor: MaterialStateProperty.resolveWith((states) {
          if (states.contains(MaterialState.disabled)) {
            return Colors.grey; // Color when the radio button is disabled
          }
          return lightTheme ? AppLightColors().primary : AppDarkColors().primary; // Default color
        }),
