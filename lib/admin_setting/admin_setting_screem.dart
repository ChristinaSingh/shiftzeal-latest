...
import 'admin_setting_controller.dart';

class AdminsettingScreen extends StatefulWidget {
  const AdminsettingScreen({super.key});

  @override
  State<AdminsettingScreen> createState() => AdminsettingScreenState();
}
...
class AdminsettingScreenState extends State<AdminsettingScreen> {
  ...
  void initState() {
    super.initState();
    var adminsettingController =
        Provider.of<AdminsettingController>(context, listen: false);
  }

  @override
  Widget build(BuildContext context) {
    return Consumer<AdminsettingController>(
...
class ProfileState extends State<ProfileScreen> {
  ...
  void initState() {
    super.initState();
    var scheduler = Provider.of<AdminsettingController>(context, listen: false);
  }

  @override
  Widget build(BuildContext context) {
    return Consumer<AdminsettingController>(builder: (context, scheduler, child) {
      return Scaffold(
