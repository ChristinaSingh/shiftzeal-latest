...
import 'add_schedules_controller.dart';

class AddSchedulesScreen extends StatefulWidget {
  const AddSchedulesScreen({super.key});
...
class _AddSchedulesScreenState extends State<AddSchedulesScreen> {
  ...
  void initState() {
    super.initState();
    var addSchedulesController =
        Provider.of<AddSchedulesController>(context, listen: false);
  }

  @override
  Widget build(BuildContext context) {
    return Consumer<AddSchedulesController>(
      builder: (context, controller, child) {
        return Scaffold(
          ...
          appBar: CommonWidgets.appBar(
              context: context, title: StringConstants.addSchedules),
