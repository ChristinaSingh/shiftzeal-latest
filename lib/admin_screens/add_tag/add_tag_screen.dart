...
import 'add_tag_controller.dart';
...
class _AddTagScreenState extends State<AddTagScreen> {
  ...
  void initState() {
    super.initState();
    var addTagController =
        Provider.of<AddTagController>(context, listen: false);
  }

  @override
  Widget build(BuildContext context) {
    return Consumer<AddTagController>(
      builder: (context, controller, child) {
        return Scaffold(
          ...
          appBar: CommonWidgets.appBar(
              context: context, title: StringConstants.tags),
