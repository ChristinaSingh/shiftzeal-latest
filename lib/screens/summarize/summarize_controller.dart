...
class SummarizeController extends ChangeNotifier {
  ...
  final List<String> summaryPoints = [
    ...
    "How time management influences productivity, well-being, and satisfaction with life",
    "Planning and executing tasks with awareness of time as a finite resource",
    "Accomplishing more in less time, reducing stress, and achieving better work-life balance",
  ];
