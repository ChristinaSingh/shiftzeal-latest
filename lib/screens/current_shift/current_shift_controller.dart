...
class CurrentShiftController extends ChangeNotifier {
  ...
  void clickOnShiftSwapButton({required BuildContext context , required String shiftId}) {
    NavigationMethods.pushMethod(
      context: context,
      widget:  ShiftDetailsScreen(shiftId:  shiftId),
    );
  }
