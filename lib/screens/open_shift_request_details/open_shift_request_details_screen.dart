...
import 'open_shift_request_details_controller.dart';

class OpenShiftRequestDetailsScreen extends StatefulWidget {
  const OpenShiftRequestDetailsScreen({super.key});

  @override
  State<OpenShiftRequestDetailsScreen> createState() =>
      _OpenShiftRequestDetailsScreenState();
}

class _OpenShiftRequestDetailsScreenState
    extends State<OpenShiftRequestDetailsScreen> {
  @override
  void initState() {
    super.initState();
    var openShiftRequestDetailsController =
        Provider.of<OpenShiftRequestDetailsController>(context, listen: false);
  }
          ...
          body: SafeArea(
              child: Column(
                children: [
                  ...
                  GestureDetector(
                    onTap: () {
                      controller.clickOnTaskList(context: context);
                    },
                    child: Padding(
                          ...
                          children: [
                            Container(
                                ...
                                child: CommonWidgets.appIcons(
                                    assetName: IconConstants.icProfileSiftDetails,
                                    height: 40.px,
                                    width: 40.px)),
                  ...
                  GestureDetector(
                    onTap: () {
                      controller.clickOnReportAbsenceButton(context: context);
                    },
                    child: Padding(
                      ...
                      child: Column(
                        children: [
                          ...
                          // Daily Report & Shift Swap Buttons
                          Row(
                            children: [
                              // Daily Report
                              Expanded(
                                child: SizedBox(
                                  ...
                                  child: OutlinedButton.icon(
                                    ...
                                    onPressed: () {
                                      controller.clickOnDailyReportButton(
                                          context: context);
                                    },
                                    icon: Icon(
                                      Icons.bar_chart,
                                    ...
                                    style: OutlinedButton.styleFrom(
                                      side: BorderSide(
                                          color: Color(0xFF019874), width: 2.px),
                              ...
                              Expanded(
                                child: SizedBox(
                                  ...
                                  child: OutlinedButton.icon(
                                    ...
                                    style: OutlinedButton.styleFrom(
                                      side: BorderSide(
                                          color: Color(0xFF6D28D9), width: 2.px),
                                      shape: RoundedRectangleBorder(
                                        borderRadius: BorderRadius.circular(16),
                                      ),
                                    ),
