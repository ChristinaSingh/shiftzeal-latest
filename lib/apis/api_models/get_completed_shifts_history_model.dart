class GetCompletedShiftModel {
  bool? success;
  List<CompletedShiftsData>? data;
  String? message;
  dynamic notification;
  dynamic error;
  String? status;

  GetCompletedShiftModel({
    this.success,
    this.data,
    this.message,
    this.notification,
  ...
  factory GetCompletedShiftModel.fromJson(Map<String, dynamic> json) {
    return GetCompletedShiftModel(
      success: json['success'],
      data: json['data'] != null
          ? List<CompletedShiftsData>.from(json['data'].map((v) => CompletedShiftsData.fromJson(v)))
          : null,
...
class CompletedShiftsData {
  ...
  factory CompletedShiftsData.fromJson(Map<String, dynamic> json) {
    return CompletedShiftsData(
      id: json['id'],
      userId: json['user_id'],
      name: json['name'],
