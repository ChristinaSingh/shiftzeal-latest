class GetCurrentShiftModel {
  ...
  factory GetCurrentShiftModel.fromJson(Map<String, dynamic> json) {
    return GetCurrentShiftModel(
      success: json['success'],
      data: json['data'] != null ? CurrentShiftData.fromJson(json['data']) : null,
...
class CurrentShiftData {
  ...
  factory CurrentShiftData.fromJson(Map<String, dynamic> json) {
