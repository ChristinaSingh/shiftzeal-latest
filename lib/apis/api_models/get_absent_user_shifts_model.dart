class GetAbsentShiftModel {
  bool? success;
  List<AbsentShiftsData>? data;
  String? message;
  ...
  factory GetAbsentShiftModel.fromJson(Map<String, dynamic> json) {
    return GetAbsentShiftModel(
      success: json['success'],
      data: json['data'] != null
          ? (json['data'] as List).map((e) => AbsentShiftsData.fromJson(e)).toList()
          : null,
...
class AbsentShiftsData {
  ...
  factory AbsentShiftsData.fromJson(Map<String, dynamic> json) {
    return AbsentShiftsData(
      id: json['id'],
      userId: json['user_id'],
      name: json['name'],
  ...
  Map<String, dynamic> toJson() {
    ...
    if (adminDetails != null) {
      map['admin_details'] = adminDetails!.toJson();
    }
