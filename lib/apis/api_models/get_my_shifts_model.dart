class GetMyShiftModel {
  bool? success;
  List<MyShiftData>? data;
  String? message;
  ...
  factory GetMyShiftModel.fromJson(Map<String, dynamic> json) {
    return GetMyShiftModel(
      success: json['success'],
      data: (json['data'] as List<dynamic>?)
          ?.map((e) => MyShiftData.fromJson(e))
          .toList(),
...
class MyShiftData {
  ...
  factory MyShiftData.fromJson(Map<String, dynamic> json) => MyShiftData(
        id: json['id'],
        userId: json['user_id'],
